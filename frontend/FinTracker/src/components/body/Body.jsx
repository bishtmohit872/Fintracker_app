                ...
                path?(
                        <div className="h-[90%] w-full py-4 px-8 flex flex-col items-center gap-4 overflow-y-scroll">
                            ...
                            <div className="lg:h-[90%] w-full flex flex-col items-center lg:flex-row lg:justify-center gap-6 lg:gap-10 lg:overflow-y-hidden">
                                ...
                                <div className="h-[500px] lg:h-[260px] lg:w-[290px] border-0 border-black w-full flex flex-col flex-shrink-0 rounded-2xl text-black bg-gray-200 shadow-2xl shadow-gray-500">
                                ...
                                <div className="h-[500px] lg:h-[260px] lg:w-[290px] border-0 border-black w-full flex flex-col flex-shrink-0 rounded-2xl text-black bg-gray-100 shadow-2xl shadow-gray-500">
